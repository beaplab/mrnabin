#define file_data        "/home/alan/Run/Hd/A14.Trinity.trimmed.linclust_rep_seq.reformat.fasta"
...
!   parameter( max_al = 4, nb = 5, nbr = 5, nc = 1 + (KKIND*8 - nbr) / nb)
  ...
  integer*CKIND     :: c(MAX_LEN_DATA), cc(MAX_SEQ_LEN)
  integer           :: ac(0: 255), al, num_rec, num_long(0: 3), tot_train
  integer           :: len_thresh(0: 3) = (/1, 1000, 2000, 3000/)
  character*1       :: a(0 :127)
  integer*4         :: vlp_ptr(0: max_al, MAX_NUM_STATES)
  integer           :: ns
  real              :: vlp_model(0: max_al, MAX_NUM_STATES)
  integer*KKIND     :: vlp_state(MAX_NUM_STATES)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  subroutine make_vlp_model(num_cluster)
    ...
    integer*KKIND :: window(MAX_LEN_DATA), w, vmask(0: nc - 1), vmskshft(0: nc - 1), vlp2_state(2, MAX_NUM_STATES)
